...
<!-- <p align="center">
    <a href="https://github.com/localzet">
        <img src="https://github-profile-trophy.vercel.app/?username=localzet&row=1&column=8&theme=darkhub&no-frame=true" alt="localzet" />
    </a>
</p>
...
### About Me
I'm a developer and researcher passionate about building high-performance, secure, and innovative IT solutions. I lead the **Localzet Group**, where we architect and develop a range of projects, from low-level networking tools to web frameworks and authentication systems.

My work is driven by a desire to create efficient and modern software, often exploring the boundaries.

### Key Projects & Ecosystem

Here are some of the projects I'm currently focused on. Many of them are part of a larger, interconnected ecosystem.

**🌐 Web Frameworks & Servers**
*   🔭 [**Async PHP Server**](https://github.com/localzet/Server) - An asynchronous, event-based PHP server for high-performance applications. The core engine for many of my projects.
*   👯 [**Triangle Web Framework**](https://github.com/Triangle-org) - A lightweight and efficient web framework (MVC) for building web applications.

**🛡️ Security & Networking Tools**
*   🔧 [**Localzet Tunnel**](https://github.com/localzet/tunnel) - A cross-server tunnel library for secure communication between servers.
*   🌟 [**Localzet Proxy**](https://github.com/localzet/proxy) - A high-performance HTTP proxy server built with PHP.

**📚 PHP Libraries & Components**
*   🔭 [**WebAnalyzer**](https://github.com/localzet/WebAnalyzer) - A library for analyzing website visitors to get detailed information about their device, OS, and browser.
*   💬 [**SocketIO**](https://github.com/localzet/SocketIO) - A PHP library for real-time, bidirectional, event-based communication.
*   🔑 [**JWT**](https://github.com/localzet/JWT) / [**LWT**](https://github.com/localzet/LWT) - Libraries for working with JSON Web Tokens and custom Localzet Web Tokens.
...
<a href="https://t.me/localzet_dev" target="blank"><img src="https://img.shields.io/badge/Telegram%20Blog-0088cc?style=for-the-badge&logo=telegram&logoColor=white" alt="Development Blog" /></a>
...
![Minikube](https://img.shields.io/badge/minikube-316192?style=for-the-badge&logo=kubernetes&logoColor=white)
